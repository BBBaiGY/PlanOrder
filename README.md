...
│   ├── SalesOrder/               # 销售订单
│   └── SalesDetail/              # 销售明细（含 DemandCalcDrawer 子组件）
...
- **CACHE_FIX.md**：浏览器/Vite 缓存与看到最新内容的解决方案
- **LIVE_SERVER_GUIDE.md**：使用 Live Server 预览构建产物的步骤
